...
public class WordCount {
	...
	public static void wordCountJava8(String filename) {
		...
		JavaPairRDD<String, Integer> counts = words.mapToPair(w -> new Tuple2<String, Integer>(w, 1))
				.reduceByKey((x, y) -> x + y);
		// Exercice
		JavaPairRDD<Integer, String> inversedCounts = counts.mapToPair(c -> new Tuple2<Integer, String>(c._2, c._1))
				.reduceByKey((x, y) -> {
	...
	// public static String longestWord(String word1, String word2){
